...
[GET /bulk/v7/backup/urls](https://www.zoho.com/crm/developer/docs/api/v7/get-backup-urls.html)
...
``` curl
Copiedcurl "https://www.zohoapis.com/crm/bulk/v7/backup/urls"
-X GET
...
Example: "https://download-accl.zoho.com/v2/crm/123456789/backup/3652397000001763003/Data\_001.zip"
...
- attachment\_linksURL



The download URL of the scheduled backup that contains all the attachments of records in all the modules.

Example: "https://download-accl.zoho.com/v2/crm/123456789/backup/3652397000001763003/Attachments\_001.zip"

Here, 123456789 is the unique ID (zgid) of the org whose data you have backed up,

3652397000001763003 is the ID of the backup job, and

Attachments\_001.zip is the file name.

- expiry\_dateDateTime
