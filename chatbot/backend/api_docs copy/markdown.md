...
- ### [Metadata APIs](https://www.zoho.com/crm/developer/docs/api/v7/module-meta.html)



[Fetch the metadata of modules, fields, layouts, custom views, and related lists.](https://www.zoho.com/crm/developer/docs/api/v7/module-meta.html)

- ### [Entity APIs](https://www.zoho.com/crm/developer/docs/api/v7/get-records.html)



[Perform CRUD operations on CRM module entities and integrate with any third party application through flexible RESTful endpoints.](https://www.zoho.com/crm/developer/docs/api/v7/get-records.html)

- ### [Composite API](https://www.zoho.com/crm/developer/docs/api/v7/composite-overview.html)



[Combine up to five API calls in a single request through this API.](https://www.zoho.com/crm/developer/docs/api/v7/composite-overview.html)

- ### [Bulk APIs](https://www.zoho.com/crm/developer/docs/api/v7/bulk-read/overview.html)



[Push and retrieve data from Zoho CRM in bulk using a set of asynchronous APIs.](https://www.zoho.com/crm/developer/docs/api/v7/bulk-read/overview.html)

- ### [Notification APIs](https://www.zoho.com/crm/developer/docs/api/v7/notifications/overview.html)



[Get notified whenever a data change occurs inside your CRM.](https://www.zoho.com/crm/developer/docs/api/v7/notifications/overview.html)

- ### [Query APIs](https://www.zoho.com/crm/developer/docs/api/v7/COQL-Overview.html)



[Fetch records using the SELECT query (SQL syntax) from Zoho CRM.](https://www.zoho.com/crm/developer/docs/api/v7/COQL-Overview.html)
