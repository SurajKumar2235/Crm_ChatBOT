...
{api-domain}/crm/{version}/settings/inventory\_templates

**To fetch details of a specific template**

{api-domain}/crm/{version}/settings/inventory\_templates/{id}

##### Supported modules

Quotes, Invoices, Purchase Orders, and Sales Orders.

All modules whose value for the key "inventory\_template\_supported" is true in the [Modules API](https://www.zoho.com/crm/developer/docs/api/v7/modules-api.html) are supported here.
...
[GET /settings/inventory\_templates](https://www.zoho.com/crm/developer/docs/api/v7/inventory_templates.html)

[GET /settings/inventory\_templates/{id}](https://www.zoho.com/crm/developer/docs/api/v7/inventory_templates.html)
...
Specify the API name of the module you want to fetch the inventory templates from. Refer to the _Supported modules_ section above.

- categorystring, optional



To filter the inventory templates based on their type. The possible values are **favorite**: templates marked as your favorite, **created\_by\_me**: templates that you created, **shared\_with\_me**: templates that other users shared with you, and **draft**: templates in your draft.

- sort\_bystring, optional



Specify based on what you want to sort your templates. The possible values are **modified\_time**: to sort based on the modified time, **last\_usage\_time**: to sort based on the latest time a template was used, and **name**: to sort based on the template's name. The default value is **modified\_time**.
...
- The **sort\_order** parameter applies to given **sort\_by** parameter value.
...
``` curl
Copiedcurl "https://www.zohoapis.com/crm/v7/settings/inventory_templates"
-X GET
