...
[GET read/{job\_id}](https://www.zoho.com/crm/developer/docs/api/v7/bulk-read/job-details.html)

### Request Details

#### Request URL

{api-domain}/crm/bulk/{version}/read/{job\_id}
...
``` curl
Copiedcurl "https://www.zohoapis.com/crm/bulk/v7/read/3652397000000646004"
-X GET
    ...
    "data": [\
        {\
            ...
            "result": {\
                ...
                "more_records": true,\
                "next_page_token": "bca6fba106357ae3b1ecbd63ff40e5adb9c13f1997c193fbc35bc140727bf03c7e46e7981c75628ca414955c020a3ee8"\
            },\
            "query": {\
                "module": {\
