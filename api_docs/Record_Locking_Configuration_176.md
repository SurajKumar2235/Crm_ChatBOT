...
[DELETE /settings/record\_locking\_configurations/{record\_locking\_config\_id}?module={module\_API\_name}](https://www.zoho.com/crm/developer/docs/api/v7/delete-record-locking-config.html)
...
scope=ZohoCRM.settings.record\_locking\_configurations.Delete
...
``` curl
Copiedcurl "https://www.zohoapis.com/crm/v7/settings/record_locking_configurations/5843104000000758004?module=Leads"
