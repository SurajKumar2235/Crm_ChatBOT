...
[POST /{personality\_module}/{record\_id}/actions/portal\_invite](https://www.zoho.com/crm/developer/docs/api/v7/invite-user.html)

### Request Details

#### Request URL

{api-domain}/crm/{version}/{personality\_module}/{record\_id}/actions/portal\_invite

Where, _personality\_module_ is the API name of the module for which the portal was created

_record\_id_ is the ID of the record that you want to invite to the portal
...
- user\_type\_idinteger, mandatory
...
``` curl
Copiedcurl "https://www.zohoapis.com/crm/v7/Contacts/3652397000000388085/actions/portal_invite?user_type_id=3652397000006231003&type=invite&language=en_US"
-X POST
...
**Resolution:** "type" and "user\_type\_id" are mandatory parameters. Refer to the "details" key in the error response to know what is missing and include it in the request.
