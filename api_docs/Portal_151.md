...
[PUT /settings/portals/{portal\_name}](https://www.zoho.com/crm/developer/docs/api/v7/update-portal.html)

### Request Details

#### Request URL

{api-domain}/crm/{version}/settings/portals/{portal\_name}
...
``` curl
Copiedcurl "https://www.zohoapis.com/crm/v7/settings/portals/PortalsAPItest100"
-X PUT
