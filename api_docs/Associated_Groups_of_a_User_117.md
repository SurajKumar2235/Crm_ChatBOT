...
[GET /users/{user\_ID}/actions/associated\_groups](https://www.zoho.com/crm/developer/docs/api/v7/associated-groups-of-a-user.html)

### Request Details

#### Request URL

{api-domain}/crm/{version}/users/{user\_ID}/actions/associated\_groups
...
Specify the **"include"** parameter to know the sources available in a group a user is associated with.


#### Sample Request

``` curl
Copiedcurl "https://www.zohoapis.com/crm/v7/users/3652397000000186017/actions/associated_groups"
-X GET
