...
[GET /crm/{version}/{personality\_module}/actions/portal\_invite](https://www.zoho.com/crm/developer/docs/api/v7/get-portal-invite-users-job-status.html)
...
The ID of the job you received in the response of the [Bulk Invite Users to a Portal API](https://www.zoho.com/crm/developer/docs/api/v7/portal-bulk-invite-users.html). When you do not include this parameter, the response will contain an array of all the jobs that were scheduled previously.

If you give an incorrect job\_id, you will get an empty response(HTTP 204).
...
"SUCCESS" represents that an invitation is successfully sent. The value "CANNOT\_PROCESS" indicates an error.
