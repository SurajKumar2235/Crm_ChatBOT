...
[POST /settings/user\_groups](https://www.zoho.com/crm/developer/docs/api/v7/create-user-group.html)

### Request Details

#### Request URL

{api-domain}/crm/{version}/settings/user\_groups
...
scope=ZohoCRM.settings.user\_groups.CREATE

#### Sample Request

``` curl
Copiedcurl "https://www.zohoapis.com/crm/v7/settings/user_groups"
