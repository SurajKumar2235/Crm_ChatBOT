...
[POST /{module\_api\_name}/upsert](https://www.zoho.com/crm/developer/docs/api/v7/upsert-records.html)

### Request Details

#### Request URL

{api-domain}/crm/{version}/{module\_api\_name}/upsert
...
leads, accounts, contacts, deals, campaigns, cases, solutions, products, vendors, pricebooks, quotes, salesorders, purchaseorders, invoices, appointments, appointments\_rescheduled\_history, services and custom.
...
``` curl
Copiedcurl "https://www.zohoapis.com/crm/v7/Leads/upsert"
