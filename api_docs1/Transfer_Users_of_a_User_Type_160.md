...
[POST /settings/portals/{portal\_name}/user\_type/{user\_type\_id}/users/action/transfer](https://www.zoho.com/crm/developer/docs/api/v7/transfer-users-del-user-type.html)

### Request Details

#### Request URL

{api-domain}/crm/{version}/settings/portals/{portal\_name}/user\_type/{user\_type\_id}/users/action/transfer
...
``` curl
Copiedcurl "https://www.zohoapis.com/crm/v7/settings/portals/ZohoTest17/user_type/1947281000000470169/users/action/transfer?transfer_To=1306462000001857001&personality_ids=1306462000000659009"
...
- You have not specified either **transfer\_To** or **personality\_ids**.

**Resolution:** **transfer\_To** or **personality\_ids** are mandatory parameters.

- LICENSE\_LIMIT\_EXCEEDEDHTTP 403
