...
[POST /settings/users\_unavailability](https://www.zoho.com/crm/developer/docs/api/v7/post-user-unavailability.html)

### Request Details

#### Request URL

{api-domain}/crm/{version}/settings/users\_unavailability
...
The **name**, **id**( _mandatory_, the key "id" from the [Get Users API](https://www.zoho.com/crm/developer/docs/api/v7/get-users.html), and **zuid**( _optional_, the key "zuid" from the [Get Users API](https://www.zoho.com/crm/developer/docs/api/v7/get-users.html).
