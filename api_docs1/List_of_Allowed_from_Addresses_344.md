...
- From the configured email addresses, email aliases, and the organization's email address (if you have configured IMAP/POP/GMail). Refer to [Zoho Mail Setup](https://help.zoho.com/portal/en/kb/crm/integrations/zoho/zoho-mail) to learn how to setup Email for your account.


#### Endpoints

[GET /settings/emails/actions/from\_addresses](https://www.zoho.com/crm/developer/docs/api/v7/get-from-addresses-list.html)
...
**All** \- {api-domain}/crm/{version}/settings/emails/actions/from\_addresses
...
``` curl
Copiedcurl "https://www.zohoapis.com/crm/v7/settings/emails/actions/from_addresses"
-X GET
...
[Top](https://www.zoho.com/crm/developer/docs/api/v7/get-from-addresses-list.html#top)
